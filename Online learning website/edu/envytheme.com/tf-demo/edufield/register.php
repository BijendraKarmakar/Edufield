            ...
            <div class="container">
				<div class="classy-nav-container breakpoint-off">
					...
					<nav class="classy-navbar justify-content-between" id="EduStudyNav">
						...
						<!-- Logo -->
						<a class="nav-brand" href="index-two.html"><img src="assets/img/logo.png" alt="logo"></a>
						...
						<div class="classy-menu">
							...
							<div class="classynav">
								<ul>
									<li><a href="index-two.html" class="navbar1">Home</a>
									</li>
                                   
                                    <li><a href="about.html" class="navbar1">About Us</a>
                                    </li>
                                   
                                    <li><a href="courses-style-two.html" class="navbar1">Courses</a>
                                    </li>
                                    
                                    <li><a href="event-style-one.html" class="navbar1">Events</a>
                                    </li>
                                    																		
									<li><a href="blog-style-one.html" class="navbar1">Blog</a>
									</li>
									
									<li><a href="#">Shop</a>
										<ul class="dropdown">
											<li><a href="shop-style-one.html">Buy Cool Items</a></li>                                            
									...
									<li><a href="#"  class="active">Pages</a>
										<ul class="dropdown">											
                                            <li><a href="teacher-style-two.html">Teacher</a>                                                
                                            </li>											
									...
									<li><a href="contact-style-one.html" class="navbar1">Contact</a>										
									</li>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <div class="register-content">
                            ...
                            <h4>Are you a member? <a href="login.php">Login Now!</a></h4>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-7 col-md-7">
                            <p>Copyright <i class="icofont-copyright"></i> 2018 EduField Template by BNA. All rights reserved</p>
                        </div>
